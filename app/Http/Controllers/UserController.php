...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       // dd($request->all());
        ...
        // }
         ...
         return redirect('/dashboard/users')->with('success','user was successful.');
    ...
    public function update(Request $request, $id)
    {
     ...
     //   $user->removeRole($user->roles);
       ...
       // $user->assignRole($request->role)hkh;
        $user -> save();
    ...
    public function postprofile(Request $request, $id)
    {
     ...
     //   $user->removeRole($user->roles);
       ...
       // $user->assignRole($request->role);
        $user -> save();
        return redirect('/dashboard/profile')->with(['success','Update was successful.' ]);
    ...
    public function updatelogin(Request $request, $id)
    {
        ...
        $user -> save();
        return redirect('/dashboard/profile')->with(['success','Login Update was successful.' ]);
