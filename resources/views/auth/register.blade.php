                                ...
                                <h4 class="card-title text-center">Signup</h4>
                                 ...
                                 <form  class="login-form mt-4" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label">First name @error('name') <span class="text-danger">* <strong>{{ $message }}</strong></span> @enderror</label>
                                                <div class="form-icon position-relative">
                                                    <i data-feather="user" class="fea icon-sm icons"></i>
                                                    <input type="text" class="form-control ps-5  @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                                </div>
                                                @error('name')
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label">Your Email @error('email') <span class="text-danger">* <strong>{{ $message }}</strong></span> @enderror</label>
                                                <div class="form-icon position-relative">
                                                    <i data-feather="mail" class="fea icon-sm icons"></i>
                                                    <input type="email" class="form-control ps-5 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                                                </div>
                                                @error('email')
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label">Password @error('password') <span class="text-danger">* <strong>{{ $message }}</strong></span> @enderror</label>
                                                <div class="form-icon position-relative">
                                                    <i data-feather="key" class="fea icon-sm icons"></i>
                                                    <input type="password" class="form-control ps-5 @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                                                </div>
                                                @error('password')
                                                <span class="invalid-feedback text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="key" class="fea icon-sm icons"></i>
                                                    <input type="password" class="form-control ps-5" name="password_confirmation" required autocomplete="new-password" >
                                                </div>
